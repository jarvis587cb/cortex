...
func TestNewCortexStore_DefaultPath(t *testing.T) {
	...
	expectedPath := filepath.Join(tmpDir, ".openclaw", DefaultDBName)
...
func TestSearchMemories(t *testing.T) {
	...
	mem1 := &Memory{Type: "semantic", Content: "Coffee preferences", Tags: "coffee", Importance: 5}
	mem2 := &Memory{Type: "semantic", Content: "Tea preferences", Tags: "tea", Importance: 5}
	mem3 := &Memory{Type: "episodic", Content: "Meeting notes", Tags: "work", Importance: 7}
...
func TestGetStats(t *testing.T) {
	...
	// Create test data
	store.CreateMemory(&Memory{Type: "semantic", Content: "Test", Importance: 5})
	store.CreateMemory(&Memory{Type: "semantic", Content: "Test2", Importance: 5})
	store.CreateOrUpdateEntity(&Entity{Name: "entity1", Data: "{}"})
	store.CreateOrUpdateRelation(&Relation{From: "a", To: "b", Type: "test"})
